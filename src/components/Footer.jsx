      ...
      <div class="bg-gray-100">
        <div class="max-w-screen-lg py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
          <div class="p-5 sm:w-2/12 border-r">
            <div class="text-sm uppercase text-default-light font-bold">Menu</div>
            <ul>
              <li class="my-2">
                <a class="hover:text-default-light" href="/#">
                  Home
                </a>
              </li>
              <li class="my-2">
          ...
          <div class="p-5 sm:w-7/12 border-r text-center">
            <h3 class="font-bold text-xl text-default-light mb-4">SAG Technology</h3>
          ...
          <div class="p-5 sm:w-3/12">
            <div class="text-sm uppercase text-default-light font-bold">
              Contact Us
            </div>
            <ul>
              <li class="my-2">
        ...
        <div class="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-screen-xl">
          <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a href="/#" class="w-6 mx-1">
              <svg
                class="fill-current cursor-pointer text-gray-500 hover:text-default-light"
                width="100%"
                height="100%"
                viewBox="0 0 24 24"
                version="1.1"
          ...
          <div class="my-5">© Copyright 2022 <b>SAG Technology</b>. All Rights Reserved.</div>
        </div>
      </div>
    </>
  );

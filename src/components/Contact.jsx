...
function Contact() {
  return (
    <>
      <div className="contact_wrapper my-10">
        {/* max-w-screen-xl mt-24 px-8   md:px-12 lg:px-16 xl:px-32 py-16 */}
        <h1 className="text-4xl font-bold text-center pt-8">Get in touch</h1>
        <br />
        <br />
        <div class="container mx-auto grid-cols-1 grid gap-8 md:grid-cols-2 bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          ...
          <div class="">
            <div>
              ...
              <input
                class="w-full bg-gray-800 text-white mt-2 p-3 rounded-lg transition-all focus:text-default focus:bg-gray-300 focus:outline-none focus:shadow-outline"
                type="text"
            ...
            <div class="mt-8">
              ...
              <textarea
                class="w-full h-32 bg-gray-800 text-white mt-2 p-3 rounded-lg transition-all focus:text-default focus:bg-gray-300 focus:outline-none focus:shadow-outline"
                placeholder="Type your Message"
              ></textarea>
            </div>
            <div class="mt-8">
              <button class="uppercase text-sm font-bold tracking-wide bg-default-light text-white p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                Send Message
              </button>
            </div>
          </div>
